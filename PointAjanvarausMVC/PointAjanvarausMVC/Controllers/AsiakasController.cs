...
namespace PointAjanvarausMVC.Controllers
{
    public class AsiakasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Asiakas_ID,Etunimi,Sukunimi,Katuosoite,Postinumero,Postitoimipaikka,Henkilotunnus,Puhelinnumero_1,Huomiot,Osoite_id,Huomio_id,Puhelin_id,Hoitaja_ID,Varaus_ID,Palvelu_ID,Asiakastunnus,Sahkoposti")] Asiakkaat asiakkaat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Asiakas_ID,Etunimi,Sukunimi,Katuosoite,Postinumero,Postitoimipaikka,Henkilotunnus,Puhelinnumero_1,Huomiot,Osoite_id,Huomio_id,Puhelin_id,Hoitaja_ID,Varaus_ID,Palvelu_ID,Asiakastunnus,Sahkoposti")] Asiakkaat asiakkaat)
        {
            if (ModelState.IsValid)
            {
