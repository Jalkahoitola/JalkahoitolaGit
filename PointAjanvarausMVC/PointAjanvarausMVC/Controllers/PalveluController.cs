...
namespace PointAjanvarausMVC.Controllers
{
    public class PalveluController : Controller
    {
        ...
        {
            var palvelut = db.Palvelut.Include(p => p.Asiakkaat).Include(p => p.Toimipisteet).Include(p => p.Hoitajat);
        ...
        public ActionResult Create([Bind(Include = "Palvelu_ID,Palvelun_nimi,Palvelun_kesto,Asiakas_id,Hoitaja_id,Toimipiste_id,Varaus_id")] Palvelut palvelut)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Palvelu_ID,Palvelun_nimi,Palvelun_kesto,Asiakas_id,Hoitaja_id,Toimipiste_id,Varaus_id")] Palvelut palvelut)
        {
            if (ModelState.IsValid)
            {
